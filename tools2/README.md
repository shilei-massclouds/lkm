...
tools2 v9 `model.json + view.json` and replays the view event sequence into deterministic animation v3 causal
...
`lkm-animate MODEL VIEW -o HTML` for already-produced v9 files.
