...
tools2 v10 `model.json + view.json` and replays the view event sequence into deterministic animation v4 causal
...
`lkm-animate MODEL VIEW -o HTML` for already-produced v10 files.
