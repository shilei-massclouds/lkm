...
tools2 v11 `model.json + view.json` and replays the view event sequence into deterministic animation v4 causal
...
self-contained v1/v2/v3 HTML remains independently openable; the current generator and bundle publish only v4.
...
`lkm-animate MODEL VIEW -o HTML` for already-produced v11 files.
