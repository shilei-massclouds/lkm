...
| 领域 | 已完成任务 | 专题证据 |
| --- | --- | --- |
| charter/model/coding/arceos_ex/mm/task/signal | 同步致命 SIGSEGV、MAPERR/ACCERR、wait/SIGCHLD 与最终用户内存收口（完成基线 `7b55a842`） | [用户缺页、独立 mm、COW 与 SIGSEGV 执行边界](user-memory.md#已完成基线第四阶段同步致命-sigsegv-与最终收口) |
