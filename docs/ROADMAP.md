...
1. 推进 `of_platform_default_populate_init()`：把 DeviceTree candidates 构造为 `PlatformDevice`，并把内嵌 `DeviceRef` 挂入 `PlatformBusSubsysPrivate.klist_devices`。
