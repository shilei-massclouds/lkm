...
| `P1` | 进行中 | model/tools2/signal | Signal-driven tools2 独立工具链 | 首期隐式 Signal 推导、v5 JSON、预算、快照、text 与 animation v2 因果时刻 HTML 已闭合；后续仍需独立决策显式 DSL、handler 命名、continuation 和老工具迁移。老 tools/ 与静态 trace/SVG 保持默认责任。 | [专题](roadmap/signal-driven-tools2.md) |
