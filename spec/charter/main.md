...
- KernelInitFlow 随 KernelInitTask 发布为 Online；首次及恢复派发都由 contextual Enter 承载。
  首个 Enter 转到唯一 Start，直接驱动 PreSMP/SMP bringup、runtime、initcall、rootfs、finalize、PayloadPrepare 和
