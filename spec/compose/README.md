...
2026-07-21 Task/TaskFlow carrier 闭合审查：本轮只统一对象级 Task/Flow storage、引用与 lifecycle，
不改变 crate、module、facade、build feature 或组件发布边界；`spec/compose/main.spec` reviewed，
无需语义修改。
