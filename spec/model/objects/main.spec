...
predicate boot_init_setup_acpi_boot_tables_trimmed<T>(flow: T) -> bool;
predicate boot_init_setup_early_memtest_input_trimmed<T>(flow: T) -> bool;
predicate boot_init_setup_sparse_init_trimmed<T>(flow: T) -> bool;
predicate boot_init_setup_vmemmap_tlb_flush_trimmed<T>(flow: T) -> bool;
predicate boot_init_setup_crashkernel_trimmed<T>(flow: T) -> bool;
predicate boot_init_setup_kasan_trimmed<T>(flow: T) -> bool;
predicate boot_init_setup_acpi_rintc_trimmed<T>(flow: T) -> bool;
predicate boot_init_setup_acpi_cpu_numa_trimmed<T>(flow: T) -> bool;
predicate boot_init_setup_cbop_block_size_deferred<T>(flow: T) -> bool;
predicate boot_init_setup_boot_alternatives_deferred<T>(flow: T) -> bool;
predicate boot_init_setup_rt_signal_env_deferred<T>(flow: T) -> bool;
predicate boot_init_setup_user_isa_deferred<T>(flow: T) -> bool;
...
predicate ap_scheduler_idle_loop_selected<T>(cpu_group: T) -> bool;
predicate ap_scheduler_idle_loop_entered<T>(cpu_group: T) -> bool;
predicate ap_scheduler_mailbox_acquire_ready<T>(cpu_group: T) -> bool;
predicate ap_scheduler_reschedule_ipi_ready<T>(cpu_group: T) -> bool;
predicate ap_scheduler_idle_sleep_recheck_ready<T>(cpu_group: T) -> bool;
