 ...
 * first slice keeps those observable registry facts but defers blk-mq tag sets,
 * request_queue, bio/page cache, partition scan, uevents, sysfs, and /dev node
 * plumbing. Users must discover the registered device through BlockDeviceRegistry
 * rather than reaching directly into VirtioBlkDevice for system-level lookup.
 */
