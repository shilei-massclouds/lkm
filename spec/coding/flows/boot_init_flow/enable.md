...
`rest_init` creates KernelInitTask/KernelInitFlow and KthreaddTask/KthreaddFlow as lifetime pairs within
their Task aggregates. For each pair, Task context setup precedes embedded Flow publication; Flow becomes
Online before Task publication and enqueue visibility is committed before Task Enable.
