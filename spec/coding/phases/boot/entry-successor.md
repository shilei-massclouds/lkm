...
`SwapperVm.ActivateOnCpu(BootCPURef)` 原子提交 boot CPU Handoff；共享 Early/Trampoline controller 保持 Ready。
...
地址空间与 boot CPU Swapper controller 状态、early IRQ 关闭、EarlyDtb 销毁、MemBlock/参数/console 等对象状态
