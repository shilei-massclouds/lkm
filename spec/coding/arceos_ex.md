...
区域并按 inode size 截断；slow symlink 的 page/block-backed `page_get_link` 路径、`readlinkat`、`O_NOFOLLOW`、
`AT_SYMLINK_NOFOLLOW`、magic link、RCU walk、权限/LSM、完整 mount namespace、`..` 语义和完整 errno 仍保持
