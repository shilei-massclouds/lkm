...
OpenRC nested vfork；本片只增强 clone diagnostic 分类，不支持 child 内普通 fork、不创建第二个 runnable
`UserChild` task ref、不扩大 task graph、普通 fork、wait、exec、job-control 或 COW 语义，不属于 setuid 片。
