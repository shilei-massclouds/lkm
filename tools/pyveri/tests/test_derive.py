...
class DerivationTests(unittest.TestCase):
    ...
    def test_current_model_derivation_reaches_target(self) -> None:
        ...
        self.assertIn("> BootInitFlow.Transition::Setup State::Prepared", text)
        ...
        self.assertNotIn("EntrySuccessorPhase", derivation.states)
        self.assertEqual(derivation.states["CorePreparePhase"], "Online")
        self.assertEqual(derivation.states["MmCoreInitPhase"], "Online")
        self.assertEqual(derivation.states["BootInitFlow"], "Online")
        self.assertEqual(derivation.states["KernelInitFlow"], "Destroyed")
        self.assertEqual(derivation.states["Pid1UserAppFlow"], "Online")
        self.assertEqual(derivation.states["PayloadPreparePhase"], "Online")
        self.assertEqual(derivation.states["PayloadHandoffPreparePhase"], "Online")
        self.assertEqual(derivation.states["KernelAddrSpace"], "Online")
        self.assertEqual(derivation.states["Vm"], "Online")
        self.assertEqual(derivation.states["PhysicalDirect"], "Ready")
        self.assertEqual(derivation.states["TrampolineVm"], "Ready")
        self.assertEqual(derivation.states["EarlyVm"], "Ready")
        self.assertEqual(derivation.states["SwapperVm"], "Ready")
