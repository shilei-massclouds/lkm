...
/// Continues into BootInitFlow's first idle leaf after BootTask is restored.
...
impl IdleRuntime {
    ...
    fn do_idle_cycle(
        ...
        self.wait_while_no_need_resched(boot_flow, boot_task, local_interrupt)?;
        self.observe_need_resched(boot_flow, boot_task)?;
