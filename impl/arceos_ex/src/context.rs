...
use crate::objects::{
    ...
    scheduler::Scheduler,
    smp_bringup::{
        ApEntryPreludePhase, ApOnlineIdlePhase, ApSmpCallinPhase, CpuHotplugSyncSet,
        CpuStartProvider, SecondaryCpuOnlineAck, SecondaryCpuStartupAck, SecondaryIdleTaskSet,
        SmpBringupBoundary,
    },
    softirq::Softirq,
...
pub struct Context {
    ...
    pub ap_entry_prelude_phase: ApEntryPreludePhase,
    pub ap_smp_callin_phase: ApSmpCallinPhase,
    pub ap_online_idle_phase: ApOnlineIdlePhase,
...
impl Context {
    pub const fn new() -> Self {
        Self {
            ...
            ap_entry_prelude_phase: ApEntryPreludePhase::new(),
            ap_smp_callin_phase: ApSmpCallinPhase::new(),
            ap_online_idle_phase: ApOnlineIdlePhase::new(),
