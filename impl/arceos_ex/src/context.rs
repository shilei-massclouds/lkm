...
use crate::objects::{
    ...
    initcall::{
        ...
        InitcallTable, IrqProcViewDeferred, PlatformBusDevice, PlatformBusType,
    },
...
pub struct Context {
    ...
    pub platform_bus_device: PlatformBusDevice,
    pub platform_bus_type: PlatformBusType,
...
impl Context {
    pub const fn new() -> Self {
        Self {
            ...
            platform_bus_device: PlatformBusDevice::new(),
            platform_bus_type: PlatformBusType::new(),
